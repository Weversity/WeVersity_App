-- ==========================================
-- TIKTOK-STYLE SOCIAL NOTIFICATION TRIGGERS (VERCEL API VERSION)
-- ==========================================

-- 0. Webhook Helper Function (Updated to point to VERCEL API)
CREATE OR REPLACE FUNCTION public.send_push_webhook(payload JSONB)
RETURNS void LANGUAGE plpgsql SECURITY DEFINER AS $$
BEGIN
    -- This calls the Vercel Backend API
...
BEGIN
    ...
    IF v_video_owner_id IS NOT NULL AND v_video_owner_id != NEW.user_id THEN
        ...
        IF v_like_count > 0 AND v_like_count % 5 = 0 THEN
