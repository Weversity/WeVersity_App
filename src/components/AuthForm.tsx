        ...
        const renderFooter = () => (
            <View style={styles.footer}>
              <View style={styles.signupContainer}>
                ...
                <TouchableOpacity onPress={() => { setIsSignUp(true); setErrors({}); }}>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.legalRow}>
                    ...
                    <Text style={styles.legalText}>
                        By continuing, you agree to our <Text style={styles.linkText} onPress={() => router.push('/terms-of-service')}>Terms</Text> and <Text style={styles.linkText} onPress={() => router.push('/privacy-policy')}>Privacy Policy</Text>.
                    </Text>
                </View>
